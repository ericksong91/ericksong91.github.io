    ...
    return (
        <nav id="navbar" className="w-full bg-white fixed top-0 z-10 dark:bg-slate-900 transition-colors duration-700">
            <div id="navbar-container" className="container mx-auto py-5 flex items-center justify-between">
                ...
                {theme !== 'dark' ?
                    <svg id="navbar-dark-light-toggle" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="hidden md:block w-6 cursor-pointer mr-5 hover:animate-wiggle" onClick={() => darkToggle()}>
                        <path d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" />
                    </svg>
                    :
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="hidden md:block w-6 cursor-pointer mr-5 text-white hover:animate-wiggle" onClick={() => darkToggle()}>
