...
function Contact() {
    return (
        <div id="contact-me" className="dark:bg-slate-900">
            ...
            <form id="contact-form" className="mt-5 p-8 flex flex-col gap-5 items-center">
                ...
                <button className="w-1/2 bg-indigo-600 text-white font-medium px-3 py-2 rounded-md cursor-pointer">Submit</button>
            </form>
        </div>
    );
};
